      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
    			...
    			<div class="form-group">
    				...
    				<input type="text" id="title" class="form-control"  required="required" name="data[Partner][title]"  >
    			</div>
          <div class="form-group">
            <label for="inputName">Ссылка</label>
            <input type="text" id="inputName" class="form-control"  required="required" name="data[Partner][link]"  >
          </div>
          <div class="form-group">
            <label for="editor2">Текст</label>
            <textarea id="editor2" class="form-control"  name="data[Partner][body]" ></textarea>
          </div>
            <div class="form-group ">
