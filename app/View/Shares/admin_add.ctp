      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
    			...
    			<div class="form-group">
    				...
    				<input type="text" id="inputName" class="form-control" required="required" name="data[Share][title]"  >
    			</div>
    			<div class="form-group">
    				<label for="editor2">Текст</label>
    				<textarea id="editor2" class="form-control"  name="data[Share][body]" ></textarea>
    			</div>
          <!-- <div class="form-group">
              <label>Ссылка :</label>
              <input type="text" id="inputName" class="form-control" name="data[Share][link]"  >
          </div> -->
          <div class="form-group ">
        ...
        <div class="card card-secondary">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" id="seoKeywords" class="form-control" name="data[Share][keywords]" />
                </div>
                <div class="form-group">
                    <label for="seoDescription">Описание</label>
                    <textarea id="seoDescription" class="form-control" name="data[Share][description]"></textarea>
                </div>
            </div>
            <!-- /.card-body -->
        </div>
