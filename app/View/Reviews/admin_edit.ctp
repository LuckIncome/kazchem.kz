    ...
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <div class="card-body">
              ...
              <input type="text" id="inputName" class="form-control"  required="required" name="data[Review][company]" value="<?=(!empty($data['Review']['company'])) ? $data['Review']['company'] : '' ?>"  >
            </div>
      			<div class="form-group">
      				<label for="inputName">ФИО</label>
      				<input type="text" id="inputName" class="form-control"  required="required" name="data[Review][name]" value="<?=(!empty($data['Review']['name'])) ? $data['Review']['name'] : '' ?>"  >
      			</div>
      			<div class="form-group">
      				<label for="question">Отзыв</label>
      				<textarea id="question" class="form-control" name="data[Review][body]" ><?=(!empty($data['Review']['body'])) ? $data['Review']['body'] : '' ?> </textarea>
      			</div>
            <div class="form-group">
              <label for="inputName">Youtube ID</label>
              <input type="text" id="inputName" class="form-control"  required="required" name="data[Review][youtube]"  value="<?=(!empty($data['Review']['youtube'])) ? $data['Review']['youtube'] : '' ?>">
            </div>
