        ...
        <div class="card-body">
			...
			<div class="form-group">
				<label for="title">Заголовок</label>
				 <input type="text" id="title" class="form-control" name="data[About][title]" value="<?=$data['About']['title']?>" />
			...
			<div class="form-group">
				...
				<textarea id="body" class="form-control" name="data[About][body]" ><?=$data['About']['body']?></textarea>
			</div>
			<div class="form-group">
                    ...
                    <div class="info-box bg-light">
                        <div class="info-box-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="block_title" class="form-control" name="data[About][block_title]" value="<?=$data['About']['block_title']?>" />
                            </div>
                           <div class="form-group">
                                <label for="block_text">Текст</label>
                                <textarea id="block_text" class="form-control" name="data[About][block_text]" ><?=$data['About']['block_text']?></textarea>
                            </div>
                            <div class="form-group">
