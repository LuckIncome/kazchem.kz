      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
    			...
    			<div class="form-group">
    				...
    				<input type="text" id="inputName" class="form-control" name="data[Project][title]"  value="<?=$data['Project']['title']?>">
    			</div>
    			<div class="form-group">
    				<label for="inputStatus">Ссылка</label>
    				<input type="text" id="inputStatus" class="form-control" name="data[Project][status]"  value="<?=$data['Project']['status']?>">
    			</div>
    			<div class="form-group">
    				<label for="inputDescription">Краткое описание</label>
    				<textarea id="inputDescription" class="form-control" name="data[Project][short_desc]" value=""><?=$data['Project']['short_desc']?></textarea>
    			</div>
