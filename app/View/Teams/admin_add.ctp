      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
    			<div class="form-group">
    				...
    				<input type="text" id="inputName" class="form-control" required="required" name="data[Team][title]"  >
    			</div>
          <div class="form-group">
            <label for="inputName">Должность</label>
            <input type="text" id="inputName" class="form-control" required="required" name="data[Team][position]"  >
          </div>
          <div class="form-group">
            <label for="inputName">Телефон</label>
            <input type="text" id="inputName" class="form-control" required="required" name="data[Team][phone]"  >
          </div>
          <div class="form-group">
            <label for="inputName">E-mail</label>
            <input type="text" id="inputName" class="form-control" required="required" name="data[Team][email]"  >
          </div>
          <div class="form-group ">
