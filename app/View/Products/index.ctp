		...
		<div class="catalog">
			<div class="catalog_content">
				<div class="filter_block">
					...
					<form method="GET" id="filtr" class="catalog_filter" action="/products">
						...
						<div class="filter_list_block">
							...
							<select class="filter_sel" name="shape[]">
								<option value="">Выберите элемент</option>
								<?php foreach($shapes as $key => $item): ?>
									<option  value="<?=$item['Shape']['id']?>" <?=(isset($_GET['shape']) && in_array($item['Shape']['id'], $_GET['shape'])) ? 'selected' : ''?>>
										<?=$item['Shape']['title_'.$l]?>
									</option>
								<?php endforeach ?>
							</select>
						...
						<div class="filter_list_block">
							...
							<select class="filter_sel" name="period[]">
								<option value="">Выберите элемент</option>
								<?php foreach($periods as $key => $item): ?>
									<option  value="<?=$item['Period']['id']?>"  <?=(isset($_GET['period']) && in_array($item['Period']['id'], $_GET['period'])) ? 'selected' : ''?>>
