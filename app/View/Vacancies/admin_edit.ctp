        ...
        <div class="card-body">
          ...
          <div class="form-group">
              ...
              <select name="data[Vacancy][city_id]"  id="selectRegion" class="form-control custom-select">
                ...
                <option value="<?=$item['City']['id']?>" <?=  ($data['Vacancy']['city_id']  == $item['City']['id']) ? 'selected' : '' ?>><?=$item['City']['title_ru']?></option>
              <?php endforeach ?>
              </select> 
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="reqc">Требования</label>
              <textarea id="req" class="form-control" name="data[Vacancy][requirement]" ><?=$data['Vacancy']['requirement']?></textarea>
            </div>
