...
.text_item{
 ...
 <div class="center-part">
  ...
  <div class="text_item">
    <p>Введите, пожалуйста, Email, который Вы использовали для создания своего профиля на сайте kazchem.kz, и мы вышлем Вам ссылку для восстановления пароля.</p>
  </div>
   <form action="/users/forgetpwd"  method="POST" accept-charset="utf-8">
    ...
    <div class="center-part__submit">
      <button class="orange_btn form_btn more_btn" type="submit">Сбросить пароль</button>
    </div> 
