      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
    			...
    			<div class="form-group">
    				...
    				<input type="text" id="inputNameRu" class="form-control" required="required" name="data[Area][title_ru]"  >
    			</div>
    			<div class="form-group">
            <label for="inputNameKz">Название KZ</label>
            <input type="text" id="inputNameKz" class="form-control" name="data[Area][title_kz]"  >
          </div>
          <div class="form-group">
            <label for="inputNameEn">Название EN</label>
            <input type="text" id="inputNameEn" class="form-control" name="data[Area][title_en]"  >
          </div>
        </div>
        <!-- /.card-body -->
      </div>
