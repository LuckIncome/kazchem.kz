...
class Product extends AppModel{
	...
	public $hasAndBelongsToMany = array(
		'Type' => array(
       	...
       	'Shape' => array(
            'className' => 'Shape',
            'joinTable' => 'shapes_products',
            'foreignKey' => 'product_id',
            'associationForeignKey' => 'shape_id'
        ),
        'Period' => array(
            'className' => 'Period',
            'joinTable' => 'periods_products',
            'foreignKey' => 'product_id',
            'associationForeignKey' => 'period_id'
        ),
        'Crop' => array(
            'className' => 'Crop',
            'joinTable' => 'crops_products',
            'foreignKey' => 'product_id',
            'associationForeignKey' => 'crop_id'
        )
    );

    public $hasMany = array('Composition', 'Employment'); 
	...
	public function customUploadImg($file = array()){
		...
		$path = WWW_ROOT . 'img/products/' . $fileName;
		$path_th = WWW_ROOT . 'img/products/thumbs/' . $fileName;
	...
	public function genNameFile($ext){
		...
		if(is_file(WWW_ROOT . 'img/products/' . $name)){
